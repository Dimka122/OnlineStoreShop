...
const AdminEditProduct: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await productsApi.updateProductWithImage(Number(id), form);
  ...
  if (!product) return <Container>Загрузка...</Container>;

  return (
    <Container>
      <Typography variant="h5" sx={{ my: 2 }}>Редактировать товар</Typography>
